...
export default function Modal({ isOpen, onClose, title, elementId, studentGroup, onSolved }) {
  ...
  const handleSubmit = (e) => {
    ...
    trackAttempt('main-room', trackingId, userAnswer, isCorrect)
  ...
  const getWrongAnswerFeedback = () => {
    const feedbackMessages = [
      "Not quite right. Review the information carefully and try again.",
      "Incorrect. Consider the context and try a different approach.",
      "That's not the answer. Think about the key concepts involved.",
      "Try again. Look for clues in the question or surrounding information."
    ]
  ...
  const handleHint = () => {
    ...
    trackAttempt('main-room', trackingId, 'hint_requested', false)
  }
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <p className="text-blue-700">
                  You are examining the {elementContent?.name || 'element'} to gather information.
                </p>
              </div>
              ...
              {showInfoOnly && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                  ...
                  <div className="mb-4">
                    <p className="text-green-700 mb-4">
                      {elementContent?.content?.info || 'You have discovered important information!'}
                    </p>
                  </div>
