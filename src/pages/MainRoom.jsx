...
export default function MainRoom() {
  ...
  const [generalSettings, setGeneralSettings] = useState({
    mainRoomTitle: 'Main Investigation Area',
    mainRoomDescription: 'Investigate and solve the mystery',
    mainRoomEmoji: '🔍'
  })
  ...
  const handleFinalQuestionSubmit = (e) => {
    ...
    // Track the attempt
    trackAttempt('main-room', 'final_question', finalQuestionAnswer, isCorrect)
    ...
    if (isCorrect) {
      ...
      setFinalQuestionFeedback({ 
        type: 'error', 
        message: 'Incorrect. Review your findings and try again.' 
      })
    }
  }
  ...
  const getFinalQuestion = () => {
    ...
    if (!savedFinalQuestions) return getDefaultFinalQuestion()

    try {
      const finalQuestions = JSON.parse(savedFinalQuestions)
      const groupNumber = studentInfo?.groupNumber || 1
      const groupQuestion = finalQuestions.groups?.[groupNumber] || finalQuestions.groups?.[1]
    ...
    return getDefaultFinalQuestion()
  }

  const getDefaultFinalQuestion = () => {
    return {
      id: 'final_question_default',
      question: 'Based on your investigation, what is your conclusion?',
      type: 'text',
      correctText: 'investigation complete',
      hint: 'Consider all the evidence you have gathered.',
      info: 'Investigation successfully completed!'
    }
  }
  ...
  const handleComplete = async () => {
    if (!finalQuestionSolved) {
      alert('You must complete the final question before finishing!')
      return
    }
      ...
      <div className="relative z-10 max-w-7xl mx-auto p-6">
        ...
        <div className="text-center mb-6">
          <h1 className="text-5xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-green-600">
            {generalSettings.mainRoomEmoji} {generalSettings.mainRoomTitle}
          </h1>
          <div className="h-1 w-48 mx-auto bg-gradient-to-r from-blue-500 to-purple-500 mb-4 animate-pulse"></div>
          <p className="text-blue-700 text-lg font-semibold">Group {studentInfo?.groupNumber} - {generalSettings.mainRoomDescription}</p>
        ...
        <div className="mb-6 bg-white bg-opacity-95 rounded-xl p-4 text-center shadow-xl border border-gray-200">
          ...
          <p className="text-sm text-gray-600 mb-3">
            Investigate all elements before attempting final conclusion
          </p>
          ...
          {interactiveElements.length > 0 && (
            <div className="mb-3">
              ...
              <p className="text-sm text-gray-600">
                Interactive Elements: {solvedElementsCount}/{interactiveElements.length} investigated
              </p>
            </div>
          )}
        ...
        <div className="relative bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-6 shadow-2xl border-4 border-gray-400">
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-gray-600">Explore carefully to find interactive elements</p>
          </div>
            ...
            <button
              ...
              className={`px-10 py-5 rounded-xl font-bold text-xl shadow-xl transition-all duration-300 ${
                finalQuestionSolved
                  ...
                  : 'bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white transform hover:scale-105 shadow-2xl'
              }`}
            >
              {isSubmitting ? (
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-6 rounded-t-2xl">
                <div className="flex justify-between items-center">
                  <h2 className="text-2xl font-bold">🎯 Final Investigation Question</h2>
                  <button
                ...
                <p className="text-purple-100 mt-2">
                  Based on all your investigations, provide your final conclusion
                </p>
              </div>
              ...
              <div className="p-6">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                  ...
                  <p className="text-blue-700">
                    Use all the evidence you have gathered during your investigation to answer this final question.
                  </p>
                </div>
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                      ...
                      <form onSubmit={handleFinalQuestionSubmit} className="space-y-4">
                        {finalQuestion.type === 'multiple_choice' ? (
                          ...
                          <input
                            ...
                            onChange={(e) => setFinalQuestionAnswer(e.target.value)}
                            placeholder="Enter your final conclusion..."
                        ...
                        <div className="flex gap-3">
                          ...
                          >
                            {finalQuestionFeedback?.type === 'success' ? '✅ Investigation Complete' : '🎯 Submit Final Answer'}
                          </button>
                      ...
                      {showFinalHint && finalQuestion?.hint && (
                        <div className="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                          <h4 className="font-bold text-yellow-800 mb-2">💡 Investigation Hint</h4>
                      ...
                      {finalQuestionAttempts > 0 && (
                        <div className="mt-4 text-center text-sm text-gray-500">
                          Final question attempts: {finalQuestionAttempts}
                        </div>
                      )}
                    </div>
                  )
        ...
        {/* Instructions */}
        <div className="mt-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-6 text-white shadow-xl">
          <h3 className="text-xl font-bold mb-3">🔍 Investigation Protocol</h3>
          <ul className="space-y-2 text-sm">
            <li>• <strong>Navigate:</strong> Use the turn buttons to examine different areas</li>
            <li>• <strong>Investigate:</strong> Click on interactive elements to examine them closely</li>
            <li>• <strong>Gather Evidence:</strong> Answer questions to collect clues and information</li>
            <li>• <strong>Final Question:</strong> Use all evidence to answer the concluding question</li>
            <li>• <strong>Complete:</strong> Successfully conclude your investigation to finish</li>
          </ul>
        </div>
      </div>
